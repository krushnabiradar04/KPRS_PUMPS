...
export const Footer = () => {
  return (
    <footer className="bg-dark text-white pt-5 pb-4 mt-3">
      <div className="container">
        <div className="row gy-4">
          ...
          <div className="col-md-4">
            ...
            <ul className="list-unstyled">
              {[
                ...
                <li key={idx}>
                  <a href="#" className="footer-link d-block py-1">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div className="col-md-4">
            ...
            <p className="mb-2">
              Shed No. 9, Sr. No. 82 / 6A, House No. 1527,
              <br />
              Gurukrupa Industrial Estate, Opp. Venkatesh Engg.,
              <br />
              Shivane, Pune - 411023, Maharashtra, India.
            </p>
            <p className="mb-1">
              <strong>Mobile No.:</strong> +91-95520 06841
            </p>
            <p className="mb-1">
              <strong>Sales:</strong> +91-96237 72704
            </p>
            <p className="mb-1">
              <strong>Email:</strong>{" "}
        ...
        <div className="text-center pt-4 mt-4 border-top border-secondary small">
          <span className="text-white">
            Designed by : Exads IT Solutions Pvt. Ltd. | ©️2025 KPRS PUMPS. All
            rights reserved.
          </span>
        </div>
      </div>
